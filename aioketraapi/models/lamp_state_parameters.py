...
class LampStateParameters(object):
    ...
    def __init__(self, brightness=None, master_brightness=None, net_brightness=None, dim_curve_active=None, dim_curve=None, power_on=None, vibrancy=None, cct=None, x_chromaticity=None, y_chromaticity=None):  # noqa: E501
        """LampStateParameters - a model defined in Swagger"""  # noqa: E501
    ...
    def dim_curve(self, dim_curve):
        ...
        if dim_curve not in allowed_values:
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LampStateParameters, dict):
