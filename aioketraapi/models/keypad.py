...
class Keypad(object):
    ...
    def __init__(self, id=None, is_virtual=None, level=None, name=None, serial_number=None, buttons=None):  # noqa: E501
        """Keypad - a model defined in Swagger"""  # noqa: E501
        self._id = None
